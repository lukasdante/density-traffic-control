...
const char* MQTT_SERVER = "broker.hivemq.com"; // Changed to HiveMQ
const int   MQTT_PORT   = 1883;
const char* MQTT_TOPIC  = "ub-traffic-light/signals/vertical";   // vertical topic

uint8_t peerAddress[] = {0x28, 0x56, 0x2F, 0x4A, 0x56, 0x08};    // MAC of the horizontal ESP
// --------------------------------
