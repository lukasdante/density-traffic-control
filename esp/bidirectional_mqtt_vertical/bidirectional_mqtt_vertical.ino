...
const char* MQTT_TOPIC  = "ub-traffic-light/signals/vertical";   // change to /horizontal on 2nd ESP

uint8_t peerAddress[] = {0x28, 0x56, 0x2F, 0x4A, 0x56, 0x08};    // change to MAC of other ESP
// --------------------------------
